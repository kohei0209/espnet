...
python data/wsj0_mix/scripts/prepare_1speaker_audio_and_scp.py \
...
for cond in tr cv tt; do
    ...
    python local/prepare_utt2category.py \
        ${wsj_scp_output_dir}/${task}_${min_or_max}_${sample_rate}/include_1mix/wav.scp \
        --output_dir ${wsj_scp_output_dir}/${task}_${min_or_max}_${sample_rate}/include_1mix || exit 1;
done