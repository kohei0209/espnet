...
# Copyright 2023  Waseda University (Authors: Kohei Saijo)
# This script is based on data.sh in wsj0_2mix recipe
# Apache 2.0
set -e
set -u
set -o pipefail
...
anechoic_mix_dir="$(dirname "$PWD")/enh_tse1"  # anechoic data directory
wham_noise=
