...
for cond in ["tr", "cv"]:
    ...
    for len_mode in args.len_mode:
        ...
        spk2utt_writer = open(scp_output_folder[len_mode] / "utt2spk_org", mode, encoding="UTF-8")
        ...
        for idx in tqdm(range(len(mix_df))):
            ...
            # write utt2spk file
            spk2utt_writer.write(f"{args.n_src}mix_{spk_ids}_{fname} {args.n_src}mix_{spk_ids}\n")
